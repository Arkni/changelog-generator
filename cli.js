...
var cli = meow({
	help: [
		...
		'    -p, --preset     The preset to use in order to generate the change log. `jquery`',
		'                     is the only available preset. If no preset is specified, then',
		'                     a simple changelog will be generated.',
